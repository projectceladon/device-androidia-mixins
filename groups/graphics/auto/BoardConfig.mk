...
BOARD_KERNEL_CMDLINE += vga=current i915.modeset=1 drm.atomic=1 i915.nuclear_pageflip=1 drm.vblankoffdelay=1 i915.fastboot=1 pcistub="pci-stub.ids=8086:46a6"
{{^acrn-guest}}
{{#enable_guc}}
