...
codec2_copy_modules : android.hardware.media.c2@1.0-service-v4l2 libv4l2_codec2_common libc2plugin_store
	...
	cp $(PRODUCT_OUT)/apex/com.android.vndk.v30/lib/android.hardware.media.bufferpool@1.0.so $(PRODUCT_OUT)/system/lib/android.hardware.media.bufferpool@1.0.so
	...
	cp $(PRODUCT_OUT)/apex/com.android.vndk.v30/lib64/android.hardware.media.bufferpool@1.0.so $(PRODUCT_OUT)/system/lib64/android.hardware.media.bufferpool@1.0.so
