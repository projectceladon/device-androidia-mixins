...
--- ini-sofia
this option is used to use ini-sofia configure for flash
...
--- json
this option is used to use json configure for flash
...
--- sofia
this option is used to use sofia configure for flash
