...
PRODUCT_COPY_FILES += device/intel/civ/host/vm-manager/scripts/lg-input-manager:$(PRODUCT_OUT)/scripts/lg-input-manager
PRODUCT_COPY_FILES += device/intel/civ/host/vm-manager/scripts/input-port-associations.xml:vendor/etc/input-port-associations.xml
