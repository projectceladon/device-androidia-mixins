...
PRODUCT_COPY_FILES += device/intel/project-celadon/caas/start_flash_usb.sh:$(PRODUCT_OUT)/scripts/start_flash_usb.sh
PRODUCT_COPY_FILES += device/intel/project-celadon/caas/auto_switch_pt_usb_vms.sh:$(PRODUCT_OUT)/scripts/auto_switch_pt_usb_vms.sh
PRODUCT_COPY_FILES += device/intel/project-celadon/caas/findall.py:$(PRODUCT_OUT)/scripts/findall.py
PRODUCT_COPY_FILES += device/intel/project-celadon/caas/setup_host.sh:$(PRODUCT_OUT)/scripts/setup_host.sh
