...
setup_ai_dispatcher.sh:"script for setting up ai-dispatcher and openvinotoolkit environment on host"
ai_raw_tensor.sh: "script to start ai-dispatcher raw-tensor service on host"
