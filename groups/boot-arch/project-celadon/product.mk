...
# crash dump configuration for SBL
CRASHDUMP_BASE_ADDRESS := 0x12800000
CRASHDUMP_HEAP_SIZE := 2097152
CRASHDUMP_STACK_SIZE := 131072

LIBEFIWRAPPER_DRIVERS := s8250mem32 dw3 lpmemmap lprtc acpi cf9 abl heci lifecycle nvme virtual_media
LIBEFIWRAPPER_DRIVERS_CD := s8250mem32  lpmemmap cf9 nvme
