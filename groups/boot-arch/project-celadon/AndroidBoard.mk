...
ifneq ($(BOARD_SFU_UPDATE),)
	...
	$(hide) $(ACP) $(PRODUCT_OUT)/efi/installer.efi $(efi_root)/EFI/BOOT/$(efi_default_name)
	$(hide) (cd $(efi_root) && zip -qry ../$(notdir $@) .)
...
$(hide)mcopy -Q -i $(BOARD_BOOTLOADER_VAR_IMG) $(PRODUCT_OUT)/efi/installer.efi ::EFI/BOOT/bootia32.efi;
...
bootloader: $(BOARD_BOOTLOADER_DIR) kf4abl-$(TARGET_BUILD_VARIANT)
