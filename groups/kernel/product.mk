...
PREBUILT_KERNEL_ROOT := device/intel/common/kernel/prebuilts/6.6/{{{prebuilt_kernel_target}}}/user
else
PREBUILT_KERNEL_ROOT := device/intel/common/kernel/prebuilts/6.6/{{{prebuilt_kernel_target}}}/userdebug
endif
