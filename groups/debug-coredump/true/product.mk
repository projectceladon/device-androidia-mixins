...
{{#treble}}
PRODUCT_COPY_FILES += $(LOCAL_PATH)/init.coredump.rc:root/init.coredump.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.coredump.rc
{{/treble}}
{{^treble}}
PRODUCT_COPY_FILES += $(LOCAL_PATH)/init.coredump.rc:root/init.coredump.rc:root/init.coredump.rc
{{/treble}}
endif
